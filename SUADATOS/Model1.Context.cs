...
namespace SUADATOS
{
    ...
    public partial class suaEntities : DbContext
    {
        ...
        public virtual int sp_AmortizacionBimestralINF2(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AmortizacionBimestralINF2", usuarioIdParameter);
        }
    
        public virtual int sp_AmortizacionBimestralINFDet2(Nullable<int> usuarioId, Nullable<int> clienteId, Nullable<int> anio)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AmortizacionBimestralINFDet2", usuarioIdParameter, clienteIdParameter, anioParameter);
        }
    
        public virtual int sp_AmortizacionBimestralINFDetExcel2(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AmortizacionBimestralINFDetExcel2", usuarioIdParameter);
        }
    
        public virtual int sp_CostoSocialAnual1(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_CostoSocialAnual1", usuarioIdParameter);
        }
    
        public virtual int sp_LimpiaReporte2(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_LimpiaReporte2", usuarioIdParameter);
        }
    
        public virtual int sp_ResumenPagosDetalleINF2(Nullable<int> usuarioId, Nullable<int> clienteId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ResumenPagosDetalleINF2", usuarioIdParameter, clienteIdParameter);
        }
    
        public virtual int sp_ResumenPagosINF2(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("usuarioId", usuarioId) :
                new ObjectParameter("usuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ResumenPagosINF2", usuarioIdParameter);
        }
    }
}
